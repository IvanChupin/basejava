...
- Протестируйте вашу реализацию интерактивно с помощью `com.urise.webapp.com.urise.webapp.MainArray.main()`.
...
- Протестируйте реализацию, запустив com.urise.webapp.com.urise.webapp.MainArray.main(): в IDEA слева на полях зеленая стрелка.
